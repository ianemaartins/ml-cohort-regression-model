...
Como não existem dados que explicitem de fato a migração no Brasil, propoi-se realizar uma prova de conceito para entender quais os elementos que explicam melhor os fluxos migratótios. A ideia principal é a de que  fosse feita uma investigação do caráter migratório em um ambiente controlado, com dados fictícios e que, posteriormente, as descobertas fossem expandidas para o modelo com dados reais. 
